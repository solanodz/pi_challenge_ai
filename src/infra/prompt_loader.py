"""Carga el prompt answer.txt desde el directorio de prompts."""
...
def load_answer_prompt(prompts_dir: Path) -> tuple[str, str]:
    """
    Lee answer.txt y devuelve (system_prompt, user_template).
    El archivo debe contener marcadores ---SYSTEM--- y ---USER---.
    """
    ...
    _, system_part = raw.split("---SYSTEM---", 1) # Separa el sistema del usuario
